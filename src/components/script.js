    ...
    window.tram = (function (e) {
      ...
      var f = (function (l, y, b) {
          ...
          function Z(ae, _e) {
            ...
            return (
              ...
              (H.open = function (Me) {
                if (
                  ((de = {}),
                  T(Me) ? (de = Me.call(H, st, Se, H, ae)) : w(Me) && (de = Me),
                  w(de))
                )
        ...
        F = function (l) {
          ...
          for (y = 0; y < I.length; y++)
            if (((b = I[y] + w), b in X.style))
              return { dom: b, css: D[y] + l };
        },
        G = (t.support = {
      ...
      var M = (t.frame = (function () {
        ...
        K = f(function (l) {
            ...
            if (te) {
              ...
              if (he == "object") {
                ...
                st.call(
                  ...
                  Se.call(this),
                  Fe > 0 &&
                    ((this.timer = new J({ duration: Fe, context: this })),
                    (this.active = !0),
          ...
          function Z(te) {
            ...
            typeof te == "string"
              ? ((pe = {}), (pe[te] = 1))
              : (pe = typeof te == "object" && te != null ? te : this.props),
              st.call(this, pe, Me),
              Se.call(this);
          }
          function ae(te) {
          ...
          function Se() {
            ...
            for (te in this.props)
              (pe = this.props[te]), pe.active && Ie.push(pe.string);
            (Ie = Ie.join(",")),
              this.style !== Ie &&
        ...
        m = f(function (l) {
          ...
          function w(C) {
            ...
            return (Z ? o(Z[1], Z[2], Z[3]) : C).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
          ...
          (l.init = function (C, Z, ae, _e) {
            ...
            ae[2] && (H = ae[2]),
              ...
              (this.name = H),
              (this.type = ae[1]),
              (this.duration = c(Z[1], this.duration, T.duration)),
              (this.ease = b(Z[2], this.ease, T.ease)),
              (this.delay = c(Z[3], this.delay, T.delay)),
              ...
              fe.fallback || _e.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    (this.ease != "ease" ? re + _[this.ease][0] : "") +
          ...
          (l.init = function () {
            ...
            (l.values = function (w) {
              var T,
                C = {};
              return (
                b.call(this, w, function (Z, ae, _e) {
                  (C[Z] = ae),
                    this.current[Z] === void 0 &&
                      ((T = 0),
                      ~Z.indexOf("scale") && (T = 1),
                      (this.current[Z] = this.convert(T, _e)));
                }),
                C
              );
            });
        ...
        Y = f(function (l) {
          ...
          (l.init = function (H) {
            ...
            (l.play = function () {
              this.active ||
                (this.start || (this.start = U()), (this.active = !0), y(this));
            }),
            (l.stop = function () {
      ...
      (t.fallback = function (l) {
        ...
        (t.delay = function (l, y, b) {
          return new J({ complete: y, duration: l, context: b });
        }),
      ...
      var h = e.style,
        W = e.css,
        z = { transform: G.transform && G.transform.css },
        j = {
          color: [B, L],
...
` +
  ...
  var ke = u((GW, Ds) => {
    ...
    function Ps() {
      Lt && (Lt.reject(), Je.off("load", Lt.resolve)),
        (Lt = new Tt.Deferred()),
        Je.on("load", Lt.resolve);
    }
  ...
  var Us = u((UW, Xs) => {
    ...
    Hi.define(
      ...
      (Xs.exports = function (e, t, r) {
        if (
          ((r = r || {}),
          (Hi.env("test") || Hi.env("frame")) && !r.fixture && !qm())
        )
          return { exit: 1 };
        var n = {},
          o = e(window),
        ...
        function p(L) {
          return function (q) {
            ...
            (q.thirdPartyCookiesSupported = L),
              g(R(q.bugReporterScriptPath), function () {
  ...
  var Ki = u((HW, $s) => {
    ...
    pn.triggers = {};
    pn.types = { INTRO: "w-ix-intro" + Qs, OUTRO: "w-ix-outro" + Qs };
  ...
  var Pt = u((kW, br) => {
    ...
    function Fm(e, t) {
      ...
      if (e === null || (Mm(e) !== "object" && typeof e != "function"))
        return { default: e };
      var r = Js(t);
  ...
  var Dc = u((GB, Pc) => {
    var wT = Ac(),
      ...
      PT = function (e) {
        return function (t) {
          var r;
          if (!RT(t) || (r = Nr(t)).type !== e)
            throw bo("Incompatible receiver, " + e + " required");
          return r;
        };
      };
    wT || To.state
      ? ((bt = To.state || (To.state = new qT())),
        (Nc = mo(bt.get)),
        (Oo = mo(bt.has)),
        (qc = mo(bt.set)),
        (In = function (e, t) {
    ...
    var bt, Nc, Oo, qc, Ft;
    Pc.exports = { set: In, get: Nr, has: Tn, enforce: LT, getterFor: PT };
  });
  var Gc = u((XB, Fc) => {
    var So = Dt(),
      DT = Ot(),
    ...
    Fc.exports = { EXISTS: Ao, PROPER: FT, CONFIGURABLE: GT };
  });
  var Bc = u((UB, Wc) => {
    var XT = me(),
      Xc = lt(),
    ...
    (Wc.exports = function (e, t, r, n) {
      ...
      if (
        (Xc(r) &&
          ...
          (!UT(r, "name") || (BT && r.name !== s)) && Uc(r, "name", s),
          (c = jT(r)),
    ...
    dl.exports = function (e, t) {
      ...
      if (
        ...
        for (s in t) {
          if (
            ((d = t[s]),
            e.noTargetGet ? ((E = RO(a, s)), (c = E && E.value)) : (c = a[s]),
  ...
  var wl = u((nH, Al) => {
    ...
    Al.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((qo[Lo] = WO(t)), (n = new qo()), (qo[Lo] = null), (n[bl] = t))
            : (n = Sn()),
          r === void 0 ? n : BO(n, r)
        );
      };
  ...
  var Cl = u((iH, Rl) => {
    var YO = lo(),
      ...
      Do = YO("unscopables"),
      Mo = Array.prototype;
    Mo[Do] == null && $O.f(Mo, Do, { configurable: !0, value: QO(null) });
  ...
  var Ho = u((Pr) => {
    ...
    var af = (Pr.ActionTypes = { INIT: "@@redux/INIT" });
    function uf(e, t, r) {
      var n;
      if (
      ...
      return (
        _({ type: af.INIT }),
        (n = { dispatch: _, subscribe: f, getState: E, replaceReducer: p }),
        (n[of.default] = g),
        n
      );
    }
      ...
      return function (n) {
        return function (o, i, a) {
          ...
          return (
            ...
            (c = eS.default.apply(void 0, d)(s.dispatch)),
            Zb({}, s, { dispatch: c })
          );
        };
      };
  ...
  var If = u((Cn) => {
    ...
    Cn.ixData = void 0;
    var nw = Be(),
      { IX2_RAW_DATA_IMPORTED: iw } = nw.IX2EngineActionTypes,
  ...
  var Uf = u((Dn) => {
    ...
    var lw = cw(tr()),
      ...
      Ew = { preview: {}, playback: {}, stop: {}, clear: {} },
  ...
  var Dr = u((kH, kf) => {
    var Pw = Fn();
    function Dw(e, t) {
      for (var r = e.length; r--; ) if (Pw(e[r][0], t)) return r;
      return -1;
    }
    kf.exports = Dw;
  });
  ...
  var zn = u((fk, Av) => {
    var _a = vv(),
      ...
      ON = cr(Ta),
      Xt = Sv;
    ((_a && Xt(new _a(new ArrayBuffer(1))) != bv) ||
      (ya && Xt(new ya()) != mv) ||
      (ma && Xt(ma.resolve()) != Iv) ||
      (Ia && Xt(new Ia()) != Tv) ||
      (Ta && Xt(new Ta()) != Ov)) &&
  ...
  var Pv = u((dk, Lv) => {
    ...
    function xN(e, t, r, n, o, i) {
      ...
      if (_ && !E)
        return (
          i || (i = new Oa()),
          a || wN(e) ? bN(e, t, r, n, o, i) : SN(e, t, c, r, n, o, i)
        );
      if (!(r & RN)) {
  ...
  var Qn = u((mk, Kv) => {
    ...
    function tq(e, t) {
      ...
      return r == "number" ||
        ...
        ZN(e)
        ? !0
        : eq.test(e) || !JN.test(e) || (t != null && e in Object(t));
    }
    Kv.exports = tq;
  });
  var Qv = u((Ik, Yv) => {
  ...
  var Da = u((se) => {
    ...
    var oi = eP(Pa()),
      mt = 1.70158,
      tP = (0, oi.default)(0.25, 0.1, 0.25, 1);
    se.ease = tP;
    var rP = (0, oi.default)(0.42, 0, 1, 1);
    se.easeIn = rP;
    var nP = (0, oi.default)(0, 0, 0.58, 1);
    se.easeOut = nP;
    var iP = (0, oi.default)(0.42, 0, 0.58, 1);
    se.easeInOut = iP;
    function oP(e) {
      return Math.pow(e, 2);
    }
  ...
  var ng = u((fr) => {
        ...
        switch (t.type) {
          ...
          case JP: {
            let {
              ...
              c = e;
            return (
              (0, ai.getIn)(c, [r, n]) !== n && (c = rg(c, n, a, r, i)),
              Ga(c, r, s, o, i)
            );
          }
          case eD: {
    ...
    function rg(e, t, r, n, o) {
      let i =
        r === BP ? (0, ai.getIn)(o, ["config", "target", "objectId"]) : null;
  ...
  var Cg = u((h5, Rg) => {
    ...
    function aM(e, t, r) {
      ...
      return (
        r !== void 0 &&
          ((o = nM(r)), (o = r < 0 ? iM(n + o, 0) : oM(o, n - 1))),
        tM(e, rM(t, 3), o, !0)
      );
    }
    Rg.exports = aM;
  ...
  var Zg = u((Ee) => {
    ...
    var Rt = di(pg()),
      ...
      kg = (e) => e.trim(),
      Ka = Object.freeze({ [Er]: Wg, [_r]: bM, [yr]: SM }),
      Kg = Object.freeze({
    ...
    var MM = (e, t) => e === t;
    function FM({ store: e, select: t, onChange: r, comparator: n = MM }) {
    ...
    function za({
      ...
      if (
        (oe
          ? ((re = Q.limitAffectedElements), (X = D), (I = E(Q)))
          : (X = I = E({ id: x, selector: L, selectorGuids: q })),
        t && V)
      ) {
        let F = r && (I || V === !0) ? [r] : f(D);
        if (I) {
    ...
    var Gg = /px/,
      XM = (e, t) =>
        t.reduce(
          (r, n) => (r[n.type] == null && (r[n.type] = zM[n.type]), r),
          e || {}
        ),
      UM = (e, t) =>
        t.reduce(
    ...
    function VM(e, t = {}, r = {}, n, o) {
      ...
      switch (n.actionTypeId) {
        ...
        case jg:
          return { value: (0, Rt.default)(parseFloat(i(e, li)), 1) };
        case gr: {
          let s = i(e, pt),
            c = i(e, vt),
            d,
          ...
          return (
            n.config.widthUnit === Ct
              ? (d = Gg.test(s) ? parseFloat(s) : parseFloat(r.width))
              : (d = (0, Rt.default)(parseFloat(s), parseFloat(r.width))),
            n.config.heightUnit === Ct
              ? (E = Gg.test(c) ? parseFloat(c) : parseFloat(r.height))
        ...
        case pi:
          return { value: (0, Rt.default)(i(e, fi), r.display) };
        case CM:
    ...
    function ZM(e, t, r, n, o) {
      let i = $M
          ...
          .join(" "),
        { setStyle: a } = o;
      Wt(e, Xe.TRANSFORM_PREFIXED, o),
        a(e, Xe.TRANSFORM_PREFIXED, i),
        t1(n, r) && a(e, Xe.TRANSFORM_STYLE_PREFIXED, TM);
    }
    function JM(e, t, r, n) {
    ...
    function s1(e, t, r, n, o, i) {
      ...
      switch (n.actionTypeId) {
        case gr: {
          ...
          d !== void 0 &&
            (s === Ct && (s = "px"), Wt(e, pt, i), a(e, pt, d + s)),
            E !== void 0 &&
              (c === Ct && (c = "px"), Wt(e, vt, i), a(e, vt, E + c));
          break;
        }
        case Zr: {
          JM(e, r, n.config, i);
    ...
    function c1({ store: e, elementApi: t }) {
      ...
      Object.keys(n).forEach((i) => {
        let a = n[i],
          ...
          { actionListId: c } = s,
          d = o[c];
        d && Xg({ actionList: d, event: a, elementApi: t });
      }),
    ...
    function Ug({ actionGroup: e, event: t, elementApi: r }) {
      ...
      n.forEach(({ actionTypeId: o, config: i }) => {
        ...
        (0, ht.isPluginType)(o)
          ...
          : (a = Qg({ effect: f1, actionTypeId: o, elementApi: r })),
    ...
    function l1(e, t, r) {
      ...
      o(e, dr) && Qg({ effect: Yg, actionTypeId: i, elementApi: r })(e);
    }
    var Qg =
    ...
    function p1({ actionList: e, actionItemId: t, rawData: r }) {
      let { actionItemGroups: n, continuousParameterGroups: o } = e,
        i = [],
        a = (s) => (
          i.push((0, Pg.mergeIn)(s, ["config"], { delay: 0, duration: 0 })),
          s.id === t
        );
      return (
  ...
  var rE = u((hi) => {
    ...
    var Jg = Be(),
      ...
      { RENDER_GENERAL: q1 } = Jg.IX2EngineConstants,
      {
      ...
      D1 = (e, t) => {
        ...
        for (let k = 0, { length: Q } = o; k < Q; k++) {
          let { keyframe: oe, actionItems: re } = o[k];
          if ((k === 0 && (S = re[0]), x >= oe)) {
            S = re[0];
            let X = o[k + 1],
              I = X && x !== oe;
            (L = I ? X.actionItems[0] : null),
              I && ((q = oe / 100), (P = (X.keyframe - oe) / 100));
          }
        }
        let V = {};
        if (S && !L)
          ...
          let k = (A - q) / P,
            Q = S.config.easing,
            oe = tE(Q, k, d);
          for (let re = 0, { length: X } = i; re < X; re++) {
            let I = i[re],
              D = Qa(c, I, S.config),
        ...
        return (0, Ir.merge)(e, { position: A, current: V });
      },
      M1 = (e, t) => {
        let {
            active: r,
        ...
        switch (t.type) {
          ...
          case w1: {
            ...
            return (0, Ir.set)(e, r, {
              ...
              skipToValue: k,
              customEasingFn:
                Array.isArray(I) && I.length === 4 ? N1(I) : void 0,
            });
          }
          case R1: {
  ...
  var iE = u((Ei) => {
    ...
    var B1 = Zo(),
      ...
      z1 = rE(),
      Y1 = nE(),
      { ixElements: Q1 } = K1.IX2ElementsReducer,
  ...
  var p_ = u((Q5, d_) => {
    ...
    function hG(e, t, r) {
      ...
      return (
        ...
        dG(e, t, { leading: n, maxWait: t, trailing: o })
      );
    }
    d_.exports = hG;
  });
  var _i = u((ce) => {
    ...
    var v_ = gG(tr()),
      ...
      { reifyState: GG } = EG.IX2VanillaUtils,
      XG = (e) => ({ type: _G, payload: (0, v_.default)({}, GG(e)) });
    ce.rawDataImported = XG;
    var UG = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({
      type: yG,
    ...
    var jG = (e) => ({ type: bG, payload: { actionListId: e } });
    ce.stopRequested = jG;
    var kG = () => ({ type: SG });
    ...
    var zG = (e = 1) => ({ type: wG, payload: { step: e } });
    ce.testFrameRendered = zG;
    var YG = (e, t) => ({ type: RG, payload: { stateKey: e, newState: t } });
    ce.eventStateChanged = YG;
    var QG = (e, t) => ({ type: CG, payload: { now: e, parameters: t } });
    ce.animationFrameChanged = QG;
    var $G = (e, t) => ({ type: xG, payload: { key: e, value: t } });
    ce.parameterChanged = $G;
    var ZG = (e) => ({ type: NG, payload: (0, v_.default)({}, e) });
    ce.instanceAdded = ZG;
    var JG = (e, t) => ({ type: qG, payload: { instanceId: e, time: t } });
    ce.instanceStarted = JG;
    var eX = (e) => ({ type: LG, payload: { instanceId: e } });
    ...
    var rX = ({ actionListId: e, isPlaying: t }) => ({
      type: DG,
      payload: { actionListId: e, isPlaying: t },
    });
    ce.actionListPlaybackChanged = rX;
    var nX = ({ width: e, mediaQueries: t }) => ({
      type: MG,
  ...
  var __ = u((Pe) => {
    ...
    var oX = Bt(),
      aX = Be(),
      { ELEMENT_MATCHES: rs } = oX.IX2BrowserSupport,
      {
        IX2_ID_DELIMITER: g_,
        HTML_ELEMENT: sX,
        PLAIN_OBJECT: uX,
    ...
    var mX = Element.prototype.closest
  ...
  var os = u((gK, iy) => {
    ...
    function oU(e) {
      for (
        var t = e.name + "", r = ny[t], n = iU.call(ny, t) ? r.length : 0;
        n--;
  ...
  var cy = u((yK, uy) => {
    ...
    function pU(e) {
      ...
      return (
        (t.__actions__ = dU(e.__actions__)),
    ...
    function PU(e) {
      return AU(function (t) {
        ...
        return function () {
          ...
          for (var f = 0, _ = r ? t[f].apply(this, d) : E; ++f < r; )
            _ = t[f].call(this, _);
          return _;
        };
      });
  ...
  var Wy = u((Ci) => {
    ...
    var ze = Ri(tr()),
      ...
      { COLON_DELIMITER: Sy } = Ht.IX2EngineConstants,
      { getNamespacedParameterId: Ay } = BU.IX2VanillaUtils,
      Gy = (e) => (t) => typeof t == "object" && e(t) ? !0 : t,
      rn = Gy(({ element: e, nativeEvent: t }) => e === t.target),
      fV = Gy(({ element: e, nativeEvent: t }) => e.contains(t.target)),
      ...
      nn = { handler: it(gt, je) },
      Uy = (0, ze.default)({}, nn, { types: [cs, Fy].join(" ") }),
      ls = [
      ...
      fs = { types: ls },
      pV = { PAGE_START: My, PAGE_FINISH: Dy },
      tn = (() => {
      ...
      Vy = (e) => (t, r) => {
        let { type: n } = t.nativeEvent,
          o = [cs, Fy].indexOf(n) !== -1 ? n === cs : r.isActive,
          i = (0, ze.default)({}, r, { isActive: o });
        return ((!r || i.isActive !== r.isActive) && e(t, i)) || i;
      },
      Ry = (e) => (t, r) => {
        let n = { elementHovered: hV(t) };
        return (
      ...
      EV = (e) => (t, r) => {
        let n = (0, ze.default)({}, r, { elementVisible: gV(t) });
        return (
      ...
      Ai = (e = !0) =>
        (0, ze.default)({}, Uy, {
          handler: it(
            e ? gt : rn,
            Vy((t, r) => (r.isActive ? nn.handler(t, r) : r))
          ),
        }),
      wi = (e = !0) =>
        (0, ze.default)({}, Uy, {
          handler: it(
            e ? gt : rn,
            Vy((t, r) => (r.isActive ? r : nn.handler(t, r)))
          ),
        }),
      Ny = (0, ze.default)({}, fs, {
        handler: EV((e, t) => {
      ...
      IV = {
        ...
        [eV]: Ai(),
        [tV]: wi(),
        [cV]: { types: "ecommerce-cart-open", handler: it(gt, je) },
        [uV]: { types: "ecommerce-cart-close", handler: it(gt, je) },
        [HU]: {
          types: "click",
          handler: it(
            gt,
        ...
        [kU]: (0, ze.default)({}, nn, { types: "mousedown" }),
        [KU]: (0, ze.default)({}, nn, { types: "mouseup" }),
        [zU]: {
          types: wy,
          handler: it(
            gt,
          ...
          handler: (
            ...
            switch (a) {
              ...
              default: {
                ...
                if (L && gt({ element: t, nativeEvent: n }) !== !0) break;
                let q = t.getBoundingClientRect(),
                  { left: P, top: V, width: k, height: Q } = q;
                if (!L && !_V({ left: f, top: _ }, q)) break;
                (S = !0), (A = O ? (f - P) / k : (_ - V) / Q);
                break;
              }
            }
            return (
              R && (A > 1 - qy || A < qy) && (A = Math.round(A)),
              (a !== Ht.EventBasedOn.ELEMENT || S || S !== i.elementHovered) &&
                ((A = d ? 1 - A : A),
                e.dispatch((0, Si.parameterChanged)(x, A))),
              { elementHovered: S, clientX: f, clientY: _, pageX: p, pageY: g }
            );
          },
        },
        [lV]: {
        ...
        [sV]: {
          ...
          handler: (
            ...
            if (E === Ht.EventBasedOn.VIEWPORT) {
              ...
              return (
                L !== o.scrollPercent &&
                  t.dispatch((0, Si.parameterChanged)(_, L)),
                { scrollPercent: L }
              );
            } else {
              let L = Ay(n, _),
              ...
              return (
                I !== o.scrollPercent &&
                  t.dispatch((0, Si.parameterChanged)(L, I)),
                { scrollPercent: I }
              );
            }
          },
  ...
  var ds = u((Nt) => {
    ...
    var OV = at(tr()),
      ...
      $V = 12;
    function ZV(e) {
      jt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: tW }),
        jt({
          store: e,
          select: ({ ixRequest: t }) => t.playback,
          onChange: rW,
        }),
        jt({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: nW }),
        jt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: iW });
    }
    function JV(e) {
      jt({
        store: e,
    ...
    function tW({ rawData: e, defer: t }, r) {
      let n = () => {
        Pi({ store: r, rawData: e, allowEvents: !0 }), zy();
      };
      t ? setTimeout(n, 0) : n();
    }
    function zy() {
    ...
    function rW(e, t) {
      ...
      if (n && o && E && s) {
        ...
        f && (E = VV({ actionList: f, actionItemId: o, rawData: E }));
      }
      if (
        ...
        Es({ store: t, actionListId: n }),
          Qy({ store: t, actionListId: n, eventId: i });
        let f = _s({
          store: t,
          eventId: i,
          actionListId: n,
    ...
    function nW({ actionListId: e }, t) {
      e ? Es({ store: t, actionListId: e }) : $y({ store: t }), Di(t);
    }
    function iW(e, t) {
      Di(t), Ky({ store: t, elementApi: Re });
    }
    ...
    function aW(e, t) {
      let r = (n) => {
        ...
        o.active &&
          ...
          t ? eW(e, r) : requestAnimationFrame(r));
      };
    ...
    function sW({ target: e, listenerParams: t }) {
        ...
        P.forEach((V) => {
          ...
          if (((O[re] = cW(O[re], q, V)), !g[re])) {
            ...
            Ni({
              ...
              R.push({ element: I, key: re });
            });
          }
        });
      }),
        R.forEach(({ element: L, key: q }) => {
          let P = O[q],
            V = (0, xt.default)(P, "[0].actionItems[0]", {}),
            { actionTypeId: k } = V,
            Q = Li(k) ? gs(k)(L, V) : null,
            oe = hs({ element: L, actionItem: V, elementApi: Re }, Q);
          ys({
            store: e,
            element: L,
            eventId: n,
    ...
    function gW({ logic: e, store: t, events: r }) {
      EW(r);
      ...
      (0, on.default)(s, (f, _) => {
        let p = r[_],
          { action: g, id: O, mediaQueries: R = i.mediaQueryKeys } = p,
          { actionListId: A } = g.config;
        KV(R, i.mediaQueryKeys) || t.dispatch((0, be.mediaQueriesDefined)()),
          g.actionTypeId === ot.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(p.config) ? p.config : [p.config]).forEach((S) => {
              let { continuousParameterGroupId: L } = S,
                q = (0, xt.default)(a, `${A}.continuousParameterGroups`, []),
                P = (0, SV.default)(q, ({ id: Q }) => Q === L),
                V = (S.smoothing || 0) / 100,
          ...
          (g.actionTypeId === ot.ActionTypeConsts.GENERAL_START_ACTION ||
            ps(g.actionTypeId)) &&
            Qy({ store: t, actionListId: A, eventId: O });
      });
      let c = (f) => {
          ...
          vW(s, (p, g, O) => {
            let R = r[g],
              A = _.eventState[O],
              { action: x, mediaQueries: S = i.mediaQueryKeys } = R;
            ...
            x.actionTypeId === ot.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
              ? (Array.isArray(R.config) ? R.config : [R.config]).forEach(L)
              : L();
          });
        },
        d = (0, xV.default)(c, $V),
        E = ({ target: f = document, types: _, throttle: p }) => {
          _.split(" ")
            .filter(Boolean)
            .forEach((g) => {
              let O = p ? d : c;
              f.addEventListener(g, O),
                t.dispatch((0, be.eventListenerAdded)(f, [g, O]));
            });
        };
    ...
    function Qy({ store: e, actionListId: t, eventId: r }) {
      ...
      if (c && c.useFirstGroupAsInitialState) {
        ...
        d.forEach((f) => {
          ...
          let { config: p, actionTypeId: g } = f,
            O =
              (p == null || (_ = p.target) === null || _ === void 0
                ? void 0
                : _.useEventTarget) === !0
                ? { target: s.target, targets: s.targets }
                : p,
            R = Ni({ config: O, event: s, elementApi: Re }),
            A = Li(g);
          R.forEach((x) => {
            let S = A ? gs(g)(x, f) : null;
            ys({
              destination: hs({ element: x, actionItem: f, elementApi: Re }, S),
              immediate: !0,
              store: e,
              element: x,
              eventId: r,
    ...
    function _s({
      ...
      let { ixData: d, ixSession: E } = e.getState(),
        { events: f } = d,
        _ = f[t] || {},
        { mediaQueries: p = d.mediaQueryKeys } = _,
        g = (0, xt.default)(d, `actionLists.${o}`, {}),
        { actionItemGroups: O, useFirstGroupAsInitialState: R } = g;
      if (!O || !O.length) return !1;
      i >= O.length && (0, xt.default)(_, "config.loop") && (i = 0),
        i === 0 && R && i++;
      let x =
          (i === 0 || (i === 1 && R)) &&
          ps((c = _.action) === null || c === void 0 ? void 0 : c.actionTypeId)
            ? _.config.delay
            : void 0,
      ...
      return (
        S.forEach((V, k) => {
          let { config: Q, actionTypeId: oe } = V,
            re = Li(oe),
            { target: X } = Q;
          if (!X) return;
          ...
          Ni({
            ...
            P = !0;
            let M = q === k && G === 0,
              U = XV({ element: F, actionItem: V }),
              K = hs({ element: F, actionItem: V, elementApi: Re }, $);
            ys({
              store: e,
              element: F,
              actionItem: V,
    ...
    function ys(e) {
      ...
      let { store: r, computedStyle: n } = e,
        ...
        _ = !d,
        p = MV(),
        { ixElements: g, ixSession: O, ixData: R } = r.getState(),
        A = DV(g, i),
        { refState: x } = g[A] || {},
        S = Re.getRefType(i),
        L = O.reducedMotion && ot.ReducedMotionTypes[a.actionTypeId],
        q;
      if (L && d)
        switch (
          (t = R.events[f]) === null || t === void 0 ? void 0 : t.eventTypeId
        ) {
      ...
      if (
        ...
        Zy(document.body, "ix2-animation-started", p),
        s)
      ) {
        _W(r, p);
        return;
      }
      jt({ store: r, select: ({ ixInstances: V }) => V[p], onChange: Jy }),
      ...
      if (qi(V, L.mediaQueryKey) && (n || r || o)) {
        if (d || (c === PV && o)) {
          ...
          let { ixElements: k } = t.getState(),
            { ref: Q, refType: oe, refState: re } = k[i] || {},
            X = re && re[s];
  ...
  var tm = u((It) => {
    ...
    function SW(e) {
      em(), (0, Is.startEngine)({ store: Mi, rawData: e, allowEvents: !0 });
    }
    function em() {
      (0, Is.stopEngine)(Mi);
    }
        ...
        function g(A) {
          ...
          if (((s.href = x), !(x.indexOf(":") >= 0))) {
            ...
            if (
              ...
              var L = e(s.hash);
              L.length && f.push({ link: S, sec: L, active: !1 });
              return;
            }
            if (!(x === "#" || x === "")) {
        ...
        function P(X, I) {
          ...
          if (D !== F) {
            var G = k(X, D, F),
              ...
              ne = function () {
                var M = Date.now() - $;
                window.scroll(0, Q(D, F, M, G)),
                  M <= G ? s(ne) : typeof I == "function" && I();
              };
            s(ne);
          }
        }
      ...
      (lm.exports = function (e) {
        ...
        function n(i) {
          ...
          i.addEventListener("touchstart", f, !1),
            ...
            i.addEventListener("mouseup", p, !1),
            i.addEventListener("mouseout", g, !1);
          function f(R) {
            var A = R.touches;
            (A && A.length > 1) ||
              ((a = !0),
              A ? ((s = !0), (d = A[0].clientX)) : (d = R.clientX),
              (E = d));
          }
          function _(R) {
            if (a) {
              ...
              (E = x),
                Math.abs(S) > c &&
                  r &&
                  String(r()) === "" &&
                  (o("swipe", R, { direction: S > 0 ? "right" : "left" }), g());
            }
          }
          function p(R) {
    ...
    Gi.define(
      ...
      (pm.exports = function (e, t) {
        ...
        function L() {
          ...
          n.on(
            ...
            n.on("change", s + ' form input[type="radio"]', (ie) => {
              e(`input[name="${ie.target.name}"]:not(${M})`).map((J, Oe) =>
                e(Oe).siblings(U).removeClass(K)
              );
              let Y = e(ie.target);
            ...
            ee.forEach(([ie, Y]) => {
              n.on(
                "focus",
                s + ` form input[type="${ie}"]:not(` + Y + ")",
                (J) => {
                  e(J.target).siblings(Y).addClass(v),
                    e(J.target).filter(B).siblings(Y).addClass(m);
                }
              ),
                n.on(
                  "blur",
            ...
            M.find(':input:not([type="submit"]):not([type="file"])').each(
              function (v, m) {
                var B = e(m),
                  ee = B.attr("type"),
                  ie =
                    B.attr("data-name") || B.attr("name") || "Field " + (v + 1),
                  Y = B.val();
        ...
        function I(M) {
          ...
          (ie = B.substring(ie, B.indexOf("&", ie))),
            (K["b_" + ee + "_" + ie] = ""),
            e
    ...
    function qW(e, t, r, n) {
            ...
            d.forEach(function (B, ee) {
              var ie = U("thumbnail"),
                Y = U("item")
                  ...
                  .attr("role", "tab")
                  .append(ie);
              an(Y, `show item ${ee + 1} of ${d.length}`),
                sn(B) && Y.addClass(hm),
                (f.items = f.items.add(Y)),
                oe(B.thumbnailUrl || B.url, function (J) {
                  J.prop("width") > J.prop("height")
                    ? G(J, "wide")
                    : G(J, "tall"),
                    ie.append(G(J, "thumbnail-image"));
                });
            }),
            f.strip.empty().append(f.items),
            G(f.content, "group")),
          o($(f.lightbox, "hide").trigger("focus"))
            .add("opacity .3s")
            .start({ opacity: 1 }),
          G(f.html, "noscroll"),
          g.show(m || 0)
      ...
      (g.build = function () {
        return (
          ...
          f.content
            ...
            .on("click", F("right"), A)
            .on("click", F("close"), x)
            .on("click", F("image, caption"), A),
          f.container.on("click", F("view"), x).on("dragstart", F("img"), P),
          f.lightbox.on("keydown", V).on("focusin", q),
            ...
            return (
              oe(Y, function (J) {
                ...
                m.html &&
                  ...
                  Oe.append(G(W, "embed"))),
                  m.caption &&
                    Oe.append(U("caption", "figcaption").text(m.caption)),
                  f.spinner.before(h),
                  z || j();
                function j() {
                  if (
                  ...
                  let ve = xW(v, d);
                  ne(f.arrowLeft, "inactive", ve),
                    M(f.arrowLeft, ve),
                    ve && f.arrowLeft.is(":focus") && f.arrowRight.focus();
                  let Ye = NW(v, d);
                  if (
                    (ne(f.arrowRight, "inactive", Ye),
                    M(f.arrowRight, Ye),
        ...
        (g.hide = function () {
          return (
            o(f.lightbox).add("opacity .3s").start({ opacity: 0 }).then(Q), g
          );
        }),
        (g.prev = function () {
          var v = bs(E - 1, d);
      ...
      function Q() {
        f &&
          ...
          p.forEach(function (v) {
            ...
            m &&
              (v.hidden
                ? m.attr("aria-hidden", v.hidden)
                : m.removeAttr("aria-hidden"),
              v.tabIndex
                ? m.attr("tabIndex", v.tabIndex)
      ...
      function X(v) {
        var m = v.get(0),
          ...
          fe;
        ee < Y
          ? (fe = Math.max(0, ee + ie - J))
          : ee + ie > J + Y && (fe = Math.min(ee, Oe)),
          fe != null &&
            o(f.strip).add("scroll-left 500ms").start({ "scroll-left": fe });
      }
      function I(v, m, B) {
        (this.$element = v),
          (this.className = m),
            ...
            e.each(p, function (g, O) {
              ...
              R ||
                ...
                a
                  ...
                  : R.el.on("click" + s, f(R)).on("click" + s, function (A) {
                      A.preventDefault();
                    });
            });
          },
          ...
          _(g),
            ...
            O
              ? ((R = c[O]),
                ...
                (p.items = R),
                g.items.length &&
                  ((p.index = R.length), R.push.apply(R, g.items)))
      ...
      (_m.exports = function (e, t) {
        ...
        function Q(h, W) {
          ...
          ve &&
            ...
            I(j),
            d
              ? (re(j), j.el.on("setting" + p, D(j)))
              : (X(j),
                j.button.on("click" + p, M(j)),
                j.menu.on("click" + p, "a", U(j)),
                j.button.on("keydown" + p, F(j)),
        ...
        function K(h) {
          return (
            h.outside && i.off("click" + p, h.outside),
            function (W) {
              var z = e(W.target);
        ...
        function J(h, W) {
          ...
          if (
            (h.overlay &&
              ((L = h.menu.prev()), h.overlay.show().append(h.menu)),
            z.animOver)
          ) {
            n(h.menu)
              .add(b)
              .set({ x: z.animDirect * Ve, height: ve })
              .start({ x: 0 })
              .then(T),
              h.overlay && h.overlay.width(Ve);
            return;
          }
          var w = l + Ye;
          n(h.menu).add(b).set({ y: -w }).start({ y: 0 }).then(T);
          function T() {
        ...
        function fe(h, W) {
          ...
          if (z.animOver) {
            n(h.menu)
              .add(j)
              .start({ x: Ye * z.animDirect })
              .then(y);
            return;
          }
          var l = Ve + ve;
          n(h.menu).add(j).start({ y: -l }).then(y);
          function y() {
            h.menu.height(""),
              ...
              h.overlay &&
                ...
                (L.length ? h.menu.insertAfter(L) : h.menu.prependTo(h.parent),
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        selector: ".fade-in-100ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606818",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-2": {
      ...
      action: {
        ...
        actionTypeId: "FADE_EFFECT",
        instant: false,
        config: { actionListId: "fadeIn", autoStopEventId: "e-7" },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".fade-in-300ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd960681a",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-3": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".slide-in-200ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606813",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-4": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".slide-in-from-left-200ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606817",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-5": {
      ...
      action: {
        ...
        actionTypeId: "FADE_EFFECT",
        instant: false,
        config: { actionListId: "fadeIn", autoStopEventId: "e-15" },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".fade-in-400ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd960681b",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-6": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".fade-in-200ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606819",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-9": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".slide-in-400ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606815",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-10": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".slide-in-100ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606812",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-14": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".slide-in-from-right-200ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606816",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-17": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".slide-in-300ms",
        originalId:
          "64ac1ab9a54f83f58d02a037|68904c28-a52b-bc4e-d6aa-f2dbd9606814",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-21": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64ac1ab9a54f83f58d02a034|52970ff0-cab0-5bf1-306c-5f9d4f77080c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-23": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64ac1ab9a54f83f58d02a034|d64ec909-89af-4e03-52ac-5661ab1e87b3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-25": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64ac1ab9a54f83f58d02a034|477bea50-3caa-ddd2-6e3a-0c816d345dc0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-26": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64ac1ab9a54f83f58d02a034|cf739027-d24e-ac1e-e753-955d6252f29c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-28": {
      ...
      target: {
        selector: ".nav-link",
        originalId: "03aa365d-5a97-c030-89a8-6b2e3f75ae6a",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-31": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "03aa365d-5a97-c030-89a8-6b2e3f75ae62",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-35": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "03aa365d-5a97-c030-89a8-6b2e3f75ae5f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-42": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64b2070a4bbdd414d20a3f3c|f0147734-caf4-8e4f-a639-8fffe1e68b2e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-45": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64aecd7d19d07e6ff757f47b|28251a5b-959f-ec3a-ea9b-4f03e2d8a4cb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-52": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "03aa365d-5a97-c030-89a8-6b2e3f75ae4f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-54": {
      ...
      target: {
        id: "64aecd7d19d07e6ff757f47b|f8d35f8c-40db-d0bd-b2b4-8eb86d20b013",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-56": {
      ...
      mediaQueries: ["main", "medium", "small"],
      target: {
        id: "64aecd7d19d07e6ff757f47b|96075321-d727-a019-8b41-abea06bd9a6f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-60": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "42a5dc3c-6573-cfcf-3383-ab798a0e5fe1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-64": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64ac1ab9a54f83f58d02a034|65398965-f93a-aec8-11a4-3fcdbd66f6a0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-68": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64ac1ab9a54f83f58d02a034|f15fb4de-5ad7-a67e-c90a-185a8ad6e9e4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-70": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64b2070a4bbdd414d20a3f3c|754fadff-44c9-d019-6644-c6c93ade6226",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-73": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64b2070a4bbdd414d20a3f3c|6e18a532-9866-5e3f-a9e5-41b6ac6880f6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-79": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64ac1ab9a54f83f58d02a037|dca296b2-5a1a-86a1-5d85-926f9d256a49",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
    a: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".link-arrow",
                  selectorGuids: ["8d78b84c-8cba-2169-49f9-dfdd122ccdde"],
                },
                xValue: 0,
                yValue: 0,
                xUnit: "px",
      ...
      createdOn: 1689007468766,
    },
    "a-2": {
      id: "a-2",
      title: "Hero Looped Text",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".looped-text",
                  selectorGuids: ["0fcb7a93-526c-72eb-6a20-bdd1c59562b0"],
                },
                zValue: 0,
                xUnit: "DEG",
                yUnit: "DEG",
    ...
    "a-3": {
      ...
      createdOn: 1689179523440,
    },
    "a-4": {
      id: "a-4",
      title: "Nav Link Hover Animation",
      continuousParameterGroups: [
        {
          id: "a-4-p",
          type: "MOUSE_X",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ["32da036c-64e6-3368-e270-71f5b3b723d3"],
                    },
                    xValue: -10,
                    xUnit: "px",
                    yUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".nav-dot",
                      selectorGuids: ["b87ad2e9-6ff4-22f5-7cfb-003a932b422e"],
                    },
                    xValue: -5,
                    xUnit: "px",
                    yUnit: "PX",
    ...
    "a-7": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["4bbad1ab-387c-abe0-ce80-b5cfd0a38ffe"],
                },
                yValue: 50,
                xUnit: "PX",
                yUnit: "px",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1689520268896,
    },
    "a-8": {
      id: "a-8",
      title: "Menu Btn Hover Out",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  selector: ".fixed-nav-menu-container",
                  selectorGuids: ["ccdf4611-4603-5863-bd13-a5ee6c36aceb"],
                },
                value: "none",
              },
            },
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".fixed-nav-menu-wrapper",
                  selectorGuids: ["a2d408b8-bcbd-2283-86c6-06155a0a7003"],
                },
                xValue: 500,
                yValue: null,
                xUnit: "vh",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  selector: ".nav-bg",
                  selectorGuids: ["d1743b07-b4c4-70d5-4ba0-357368df4243"],
                },
                xValue: 100,
                xUnit: "vw",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".fixed-nav-menu",
                  selectorGuids: ["38d02315-d218-584f-15d1-de9679b49ac7"],
                },
                xValue: 100,
                xUnit: "vw",
                yUnit: "PX",
    ...
    "a-11": {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ["dc4a2456-1948-0266-c38d-9609585cbb41"],
                    },
                    value: 0,
                    unit: "",
                  },
                ...
                },
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      selector: ".nav-links-wrapper",
                      selectorGuids: ["ab63ee15-ae0e-557a-6ba4-c4b12d3f58da"],
                    },
                    value: 1,
                    unit: "",
                  },
      ...
      createdOn: 1689529098717,
    },
    "a-36": {
      id: "a-36",
      title: "Loop Animation 2",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".i-can-help-row._1",
                  selectorGuids: [
                    "c10fefaa-c8f9-f2bc-2895-7f6dad36c86f",
                    "e7c1d062-908a-38c7-76e3-6f70313ac597",
                  ],
                },
                xValue: 0,
                xUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".i-can-help-row._2",
                  selectorGuids: [
                    "c10fefaa-c8f9-f2bc-2895-7f6dad36c86f",
                    "07e64287-f77c-6619-a702-9657bf814ad8",
                  ],
                },
                xValue: 0,
                xUnit: "px",
              ...
              actionItems: [
                ...
                },
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      id: "64aecd7d19d07e6ff757f47b|24cfd2bf-4553-7543-dd0b-8f9720521845",
                    },
                    xValue: -5,
                    xUnit: "px",
                    yUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".live-link-icon",
                      selectorGuids: ["529bed75-172f-b223-8ce6-2349847be937"],
                    },
                    xValue: -5,
                    xUnit: "px",
                    yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".project-link-orange-bg",
                  selectorGuids: ["94520537-4f03-4c54-a7ea-8c7b95c3fd0e"],
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "px",
    ...
    "a-21": {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      selector: ".page-scroll-dot",
                      selectorGuids: ["1df340dd-016b-9d5f-1a4c-a4993642fde8"],
                    },
                    yValue: 0,
                    xUnit: "PX",
                    yUnit: "px",
      ...
      createdOn: 1689544487238,
    },
    "a-22": {
      id: "a-22",
      title: "Next Link Hover In",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".right-link-divider",
                  selectorGuids: ["b295a5b8-b10e-7cbf-2601-35cf07194598"],
                },
                widthValue: 0,
                widthUnit: "px",
                heightUnit: "PX",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1689562314298,
    },
    "a-23": {
      id: "a-23",
      title: "Next Link Hover Out",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".left-link-divider",
                  selectorGuids: ["09bda958-d9fc-afd8-cc57-eb280bbd3909"],
                },
                widthValue: 0,
                widthUnit: "px",
                heightUnit: "PX",
    ...
    "a-28": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".mail-icon",
                  selectorGuids: ["d9d213c9-31d2-957c-fa78-e7431061f80c"],
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".mail-link-arrow-icon",
                  selectorGuids: ["057b0c66-b037-100d-29ed-05c5c9ee5b69"],
                },
                yValue: 100,
                xUnit: "PX",
                yUnit: "px",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1689692930956,
    },
    "a-29": {
      id: "a-29",
      title: "Mail Link Hover Out",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-30": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64b2070a4bbdd414d20a3f3c|9f16502a-a384-d218-52e1-7b1643059ac2",
                },
                zValue: 0,
                xUnit: "DEG",
                yUnit: "DEG",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1689697405773,
    },
    "a-12": {
      id: "a-12",
      title: "Work Block Hover In",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".work-block-image",
                  selectorGuids: ["628a3bb5-8b53-cb06-6d47-2a36d551290c"],
                },
                xValue: 1,
                yValue: 1,
                locked: true,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  selector: ".link-line",
                  selectorGuids: ["c2268a87-5e04-51ac-bbbe-78e34e306190"],
                },
                widthValue: 25,
                widthUnit: "px",
                heightUnit: "PX",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1689530005598,
    },
    "a-13": {
      id: "a-13",
      title: "Work Block Hover Out",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-32": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".animating-word",
                  selectorGuids: ["39b0f7b1-fb56-a60f-9159-28f10beae656"],
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "px",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1689763570240,
    },
    "a-34": {
      id: "a-34",
      title: "Process Card Animation",
      continuousParameterGroups: [
        {
          id: "a-34-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".step-card._1",
                      selectorGuids: [
                        "71e267c0-bcae-e0bf-24d3-e99638e8efb6",
                        "4217a574-c464-b036-32e6-1ae1801fc29c",
                      ],
                    },
                    xValue: 1,
                    yValue: 1,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "71e267c0-bcae-e0bf-24d3-e99638e8efb6",
                        "51142874-c4c2-abf8-7819-e34e9cfeeddd",
                      ],
                    },
                    xValue: 1,
                    yValue: 1,
              ...
              actionItems: [
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".step-card._3",
                      selectorGuids: [
                        "71e267c0-bcae-e0bf-24d3-e99638e8efb6",
                        "8ed9f0fd-2a3a-4b5b-a70c-2b837ef7d662",
                      ],
                    },
                    yValue: 0,
                    xUnit: "PX",
      ...
      createdOn: 1689532324909,
    },
    "a-35": {
      id: "a-35",
      title: "Looped words Tablet",
      actionItemGroups: [
        {
          actionItems: [
            {
